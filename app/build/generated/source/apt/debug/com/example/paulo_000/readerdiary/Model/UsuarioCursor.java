...
public final class UsuarioCursor extends Cursor<Usuario> {
    ...
    static final class Factory implements CursorFactory<Usuario> {
        @Override
        public Cursor<Usuario> createCursor(Transaction tx, long cursorHandle, BoxStore boxStoreForEntities) {
    ...
    public UsuarioCursor(Transaction tx, long cursor, BoxStore boxStore) {
